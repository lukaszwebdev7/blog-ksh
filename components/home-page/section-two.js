				...
				<div className="flex flex-col md:flex-row ">
					...
					<div className="text-justify md:text-left bg-category px-2">
						<div
							...
							className="text-lg md:text-3xl xl:text-4xl text-gray font-bold px-2 rounded tracking-wider my-6"
						>
						...
						<div className="text-base xl:text-xl mb-10 uppercase text-justify">
							...
							<div className="flex flex-row items-center my-2 p-2 tracking-wide">
								...
								<div>
									...
									działalności spółki, składu osobowego spółek, sposobu reprezentacji spółek, sposobu
									uczestniczenia w zyskach i stratach, i innych
								</div>
							</div>
							<div className="flex flex-row items-center my-2 p-2 tracking-wide">
								<div>
							...
							<div className="flex flex-row items-center my-2 p-2 tracking-wide">
								...
								<div>
									...
									ramach tworzenia podmiotów i wprowadzania zmian w spółkach, reprezentacji przed
									sądami rejestrowymi
								</div>
							</div>
							<div className="flex flex-row items-centermy-2 p-2 tracking-wide">
								...
								<div>
									...
									wykorzystaniem elektronicznych środków komunikacji
								</div>
							</div>
						</div>
					</div>
